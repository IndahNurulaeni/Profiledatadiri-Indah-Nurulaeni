...
<?php $__env->startSection('title','Kontraks'); ?>
...
<table class="table">
  ...
  <tbody>
  <?php $__currentLoopData = $kontraks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontrak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <tr>
    <td><?php echo e($kontrak->mahasiswa_id); ?></td>
    <td><?php echo e($kontrak->semester_id); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UAS\resources\views/kontraks/index.blade.php ENDPATH**/ ?>